# TOAE_CONSOLE_URL variable can be overidden in variables.pkrvars.hcl
variable "TOAE_CONSOLE_URL" {
  type      = string
  default   = ""
  sensitive = false
}

# TOAE_KEY variable can be overidden in variables.pkrvars.hcl
variable "TOAE_KEY" {
  type      = string
  default   = ""
  sensitive = true
