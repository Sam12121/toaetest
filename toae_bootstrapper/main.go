...
import (
	...
	"github.com/Sam12121/toaetest/toae_bootstrapper/cgroups"
	"github.com/Sam12121/toaetest/toae_bootstrapper/config"
	"github.com/Sam12121/toaetest/toae_bootstrapper/controls"
	...
	dfUtils "github.com/Sam12121/df-utils"
)
...
func main() {
	...
	err = server.StartRPCServer(ctx, "/tmp/toae_boot.sock")
	if err != nil {
		log.Panic().Msgf("%v", err)
	}
