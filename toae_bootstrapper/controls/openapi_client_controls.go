...
import (
	...
	"github.com/Sam12121/golang_toae_sdk/client"
	"github.com/Sam12121/golang_toae_sdk/utils/http"
)
...
func newClient() (*http.OpenapiHttpClient, error) {
	...
	if strings.Trim(apiToken, "\"") == "" && http.IsConsoleAgent(url) {
		...
		return nil, errors.New("TOAE_KEY not set")
	}
