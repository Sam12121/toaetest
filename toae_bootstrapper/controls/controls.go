...
import (
	...
	"github.com/Sam12121/toaetest/toae_bootstrapper/router"
	"github.com/Sam12121/toaetest/toae_bootstrapper/supervisor"
	ctl "github.com/Sam12121/toaetest/toae_utils/controls"
	"github.com/Sam12121/toaetest/toae_utils/log"
	linuxScanner "github.com/Sam12121/compliance/scanner"
	linuxScannerUtil "github.com/Sam12121/compliance/util"
)
...
func SetClusterAgentControls(k8sClusterName string) {
	...
	_, err = exec.Command("/bin/sh", "/home/toae/token.sh").CombinedOutput()
	if err != nil {
...
func SetAgentControls() {
	...
	err = router.RegisterControl(ctl.SendAgentDiagnosticLogs,
		func(req ctl.SendAgentDiagnosticLogsRequest) error {
			...
			return SendAgentDiagnosticLogs(req,
				[]string{"/var/log/supervisor", "/var/log/fenced", "/var/log/toaed"},
