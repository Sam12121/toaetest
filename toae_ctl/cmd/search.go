...
var topCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		orderFilter := toae_server_client.ReportersOrderFilter{
			OrderFields: []toae_server_client.ReportersOrderSpec{{FieldName: type2field(search_type)}},
		}

		filtreq := toae_server_client.SearchSearchNodeReq{
			NodeFilter: toae_server_client.SearchSearchFilter{
			...
			Window: toae_server_client.ModelFetchWindow{Offset: 0, Size: int32(num)},
		}
...
var issuesCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		filtreq := toae_server_client.SearchSearchNodeReq{
			...
			Window: toae_server_client.ModelFetchWindow{Offset: 0, Size: 0},
		}
