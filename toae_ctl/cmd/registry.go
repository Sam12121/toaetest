...
var imagesSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		filters := toae_server_client.ReportersContainsFilter{
		...
		req = req.ModelRegistryImageStubsReq(
			toae_server_client.ModelRegistryImageStubsReq{
				ImageFilter: toae_server_client.ReportersFieldsFilters{ContainsFilter: filters},
