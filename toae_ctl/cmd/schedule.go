...
var scheduleTaskAddSubCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		filters := toae_server_client.SearchSearchFilter{}
		...
		cFilters := toae_server_client.ReportersContainsFilter{
		...
		var mAddTaskReq toae_server_client.ModelAddScheduledTaskRequest
