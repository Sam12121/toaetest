...
import (
	...
	"github.com/Sam12121/toaetest/toae_server/pkg/sendemail"
...
func (h *Handler) RegisterUser(w http.ResponseWriter, r *http.Request) {
	...
	consoleURLSetting := model.Setting{
		...
		Value: &model.SettingValue{
			Label:       "Toae Console URL",
			Value:       consoleURL,
			Description: "Toae Console URL used for sending emails with links to the console",
		},
		IsVisibleOnUI: true,
	}
...
func (h *Handler) UpdateUserPassword(w http.ResponseWriter, r *http.Request) {
	...
	if user.Email == constants.ToaeCommunityEmailID {
...
func (h *Handler) ResetPasswordRequest(w http.ResponseWriter, r *http.Request) {
	...
	if resetPasswordRequest.Email == constants.ToaeCommunityEmailID {
