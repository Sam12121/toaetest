...
import (
	...
	workerUtil "github.com/Sam12121/toaetest/toae_worker/utils"
	"github.com/Sam12121/golang_toae_sdk/utils/tasks"
	psOutput "github.com/Sam12121/package-scanner/output"
	ps "github.com/Sam12121/package-scanner/scanner"
	"github.com/Sam12121/package-scanner/scanner/grype"
	psUtils "github.com/Sam12121/package-scanner/utils"
...
var (
	...
	grypeBin            = "grype"
	minioHost           = utils.GetEnvOrDefault("TOAE_MINIO_HOST", "toae-file-server")
	minioPort           = utils.GetEnvOrDefault("TOAE_MINIO_PORT", "9000")
	minioRegion         = os.Getenv("TOAE_MINIO_REGION")
	minioBucket         = os.Getenv("TOAE_MINIO_DB_BUCKET")
