...
if [ -z "$TOAE_NEO4J_USER" ]; then
    export TOAE_NEO4J_USER="neo4j"
fi
if [ -z "$TOAE_NEO4J_PASSWORD" ]; then
    export TOAE_NEO4J_PASSWORD="e16908ffa5b9f8e9d4ed"
fi
if [ -z "$NEO4J_AUTH" ]; then
    export NEO4J_AUTH=$TOAE_NEO4J_USER/$TOAE_NEO4J_PASSWORD
fi
